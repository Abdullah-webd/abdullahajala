...
const About = ({isDarkMode,setIsDarkMode}) => {
  return (
    ...
    >
       ...
       >
            <motion.div className='w-[fit-content] sm:w-80 rounded-3xl max-w-none'
            ...
            >
                <p className='mb-10 max-w-20xl font-Ovo'>
                    i am an experienced Frontend Developer with 1+ years of experience in the feild. Throughout my career, I have had the priviledge of collaborating with prestigious organizations, contributing to their success and growth.
                </p>
                ...
                >
                    {
                        infoList.map(({icon,iconDark,title,description},index)=>(
                            <motion.li key={index} className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-light-hover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white dark:hover:bg-dark-hover/50'
